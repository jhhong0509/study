...
- 스푸핑
  ...
  > 악의적 목적으로 웹사이트를 구축하고, 접속을 유도해 암호 등의 정보를 입력하도록 하는 해킹 수법

- 스니핑

  > 패킷을 엿봐서 정보를 빼앗는 해킹 수법

- 피기배킹

  > 서버가 잠깐 열린 틈을 타 해킹하는 등 합법화한 물리 절차를 통해 해킹하는 것

- 소프트웨어의 분리

  > 패치 버전
  >
  > - 이미 배포된 프로그램의 오류 수정이나 성능 향상을 위해 프로그램 일부를 변경한 버전
  >
  > 알파 버전
  >
  > - 개발 초기에 평가를 위한 테스터나 개발자를 위한 버전
  >
  > 베타 버전
  >
  > - 프로그램 공개 전 일반인에게 기능을 시험하는 버전
  >
  > 트라이얼 버전
  >
  > - 일정 기간 이후 사용할 수 없는 버전
  >
  > 공개 소프트웨어
  >
  > - Freeware 라고도 한다.
  > - 아무 조건 없이 사용할 수 있는 소프트웨어
  >
  > 셰어웨어
  >
  > - 평가판이라고도 한다.
...
- 펌웨어
  ...
  > 하드웨어와 소프트웨어 중간 성격(하드웨어와 밀접한 관계를 갖는 소프트웨어)
  >
  > 하드웨어의 기능을 소프트웨어가 대신하게 해주는 것.

- 미들웨어

  > 운영체제와 응용 프로그램 사이에서 작동하는 소프트웨어로, 

- 플래시 메모리

  > 전기적 방법으로 수정이 가능한 EEPROM을 개선한 메모리 칩.

- 캐시 메모리

  > 주 기억 장치와 보조 기억 장치의 속도 차이 개선

- 가상 메모리

  > 보조 기억 장치의 일부를 주 기억 장치 처럼 사용하는 것